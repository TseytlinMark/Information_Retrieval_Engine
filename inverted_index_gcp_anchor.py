...
class MultiFileWriter:
    ...
    def upload_to_gcp(self):
        ...
        blob = self.bucket.blob(f"postings_gcp/anchor/{file_name}")
...
class InvertedIndex:  
    ...
    def posting_lists_iter(self):
        ...
        with closing(MultiFileReader()) as reader:
            for w, locs in self.posting_locs.items():
                ### I WANT TO PRINT HERE WHAT IS LOCS AND WHAT IS W
    ...
    def _upload_posting_locs(bucket_id, posting_locs, bucket_name):
        ...
        blob_posting_locs = bucket.blob(f"postings_gcp/anchor/{bucket_id}_posting_locs.pickle")
